          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
             <div className=" flex items-center gap-x-4 mb-8">
              ...
              <div className=" font-bold text-lg ">
                ...
                <Link to=' ' className="text-violet-700 text-sm"> view Listenings</Link>
              </div>
             </div>
             ...
             <textarea className="border border-gray-300
              focus:border-violet-700 
               outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400"  defaultValue='Hello ,I am Interested in [Modern apartment]' placeholder="Message">

             </textarea>
              <div className=" flex gap-x-2">
                <button className="bg-violet-700 hover:bg-violet-800 text-wrap rounded p-4 text-sm w-full transition">
                  Send Message
                </button>
                <button className=" border border-violet-700 text-violet-700 hover:border-violet-500 hover:to-violet-500 rounded p-4 text-sm w-full transition">
                  Call
                </button>
              </div>
             </form>
